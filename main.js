...
!(function (t) {
    ...
    function (t, e, n) {
        ...
        (i.resize = E(u, k)),
            ...
            (i.ready = function () {
                (d = !0), p ? ((p = !1), f.each(r, m)) : f.each(o, L), f.each(a, L), i.resize.up();
            }),
            (i.load = function (t) {
                _.then(t);
            }),
    ...
    function (t, e, n) {
        ...
        window.tram = (function (t) {
                    ...
                    "ease-out": [
                        ...
                        function (t, e, n, i) {
                            var r = (t /= i) * t,
                                o = r * t;
                            return (
                                e + n * (0.3 * o * r + -1.6 * r * r + 2.2 * o + -1.8 * r + 1.9 * t)
                            );
                        }
                    ],
                    "ease-in-out": [
            ...
            if (M.transition) {
                var $ = M.timing.dom;
                if (((z.style[$] = f["ease-in-back"][0]), !z.style[$]))
                    for (var q in h) f[q][0] = h[q];
            }
            var O = (e.frame = (function () {
                ...
                F = l(function (e) {
                        ...
                        if (t) {
                            ...
                            if ("object" == o) {
                                ...
                                d.call(
                                    ...
                                    h.call(this),
                                    c > 0 &&
                                        ((this.timer = new N({ duration: c, context: this })),
                                        (this.active = !0),
                    ...
                    (e.init = function (e) {
                        ...
                        g("stop", s),
                        g("set", function (t) {
                            s.call(this, t), d.call(this, t, v, b);
                        }),
                        g("show", function (t) {
                ...
                W = l(function (e) {
                    function n() {
                        var t,
                            ...
                            i,
                            r = u.length;
                        if (r) for (O(n), e = C(), t = r; t--; ) (i = u[t]) && i.render(e);
                    }
                ...
                return (
                    (n.ready = function () {
                        ...
                        /\.webflow\.io$/i.test(d) && u.hostname !== d && (s = !0),
                            s && !c && ((e = e), h(), setTimeout(h, 500), t(r).off(l, f).on(l, f));
                    }),
                    n
                );
            })
